                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label>Price</label>
                                                <input type="text" class="form-control" name="price" value="{{ old(key: 'price') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="allowed_properties" value="{{ old(key: 'allowed_properties') }}">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="allowed_photos" value="{{ old(key: 'allowed_photos') }}">
                                            </div>
                                        </div>
                                         <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label>Allowed Videos</label>
                                                <input type="text" class="form-control" name="allowed_videos" value="{{ old(key: 'allowed_videos') }}">
                                            </div>
                                        </div>
                                        </div>
